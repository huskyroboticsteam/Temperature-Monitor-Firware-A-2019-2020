...
avr-gcc -c display.c -o display.o -Iinclude -I. -mmcu=%MCU% -Os
avr-gcc -c twi.c -o twi.o -Iinclude -I. -mmcu=%MCU% -Os
avr-gcc -c main.c -o main.o -Iinclude -I. -mmcu=%MCU% -Os
avr-gcc main.o messaging.o spi.o usart.o motor.o encoder.o can.o adc.o pwm.o timers.o servo.o display.o twi.o util.o -mmcu=%MCU% -o avr_mc.elf
